...
public class CrimeCameraFragment extends Fragment {
	...
	public static final String EXTRA_PHOTO_ORIENTATION = 
			"com.xiamu.android.CrimeCameraFragment.photo_orientatiion";
			...
			try {
				...
				try {
					...
					if(success){
						...
						MyOrientationDector cameraOrientation = new MyOrientationDector(getActivity());
						
						int orientation = cameraOrientation.getOrientation();
						Log.d("MyOrientationDetector","当前的传感器方向为"+ getResources().getConfiguration().orientation);
						Intent i = new Intent();
						i.putExtra(EXTRA_PHOTO_FILENAME, filename);
						i.putExtra(EXTRA_PHOTO_ORIENTATION, getActivity().
		...
		holder.addCallback(new SurfaceHolder.Callback() {
			...
			public void surfaceChanged(SurfaceHolder holder, int format, int width,
				...
				if(getActivity().getResources().getConfiguration().orientation ==
					...
					Log.i("CrimeCameraFragment", "有没有在竖直拍着---------");
...
//				       parameters.set("rotation", 90);
//				       mCamera.setDisplayOrientation(90);
//				       Log.i("CrimeCameraFragment", "有没有在横着拍着---------");
//				    } 
				try {
					//用来在Surface上绘制帧
	...
	//方向变化监听器，监听传感器的方向的改变
	public class MyOrientationDector extends OrientationEventListener{

		int Orientation;
		public MyOrientationDector(Context context) {
			super(context);
